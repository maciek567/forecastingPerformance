...
class NoisedSeries:
    def __init__(self, model, all_noised_strength: dict, partially_noised_strength: dict):
        ...
        self.partially_noised_strength = self.set_partly_noised_strength(partially_noised_strength)
    ...
    @staticmethod
    def set_partly_noised_strength(partially_noised_strength: dict):
        if partially_noised_strength is not None:
            return {column: partially_noised_strength[column] if column in partially_noised_strength.keys()
