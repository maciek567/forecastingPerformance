...
deviations_graph_path = os.path.join("..", "data", "deviations", "graphs")

pred_stats_csv_path = os.path.join("..", "data", "predictions", "stats_csv")
pred_stats_tex_path = os.path.join("..", "data", "predictions", "stats_tex")
pred_graphs_path = os.path.join("..", "data", "predictions", "graphs")
